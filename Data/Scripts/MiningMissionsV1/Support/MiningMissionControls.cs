...
namespace MiningMissionsV1.Support
{
  public static class MiningMissionControls
  {
    ...
    {
      new PilotProfile(0, "Doug",     skill: 1, reliability: 2, yield: 2, speed: 2),
      new PilotProfile(1, "Dylan",    skill: 1, reliability: 1, yield: 1, speed: 3),
      new PilotProfile(0, "Marcus",   skill: 1, reliability: 3, yield: 3, speed: 1),
      ...
      new PilotProfile(3, "Carl",     skill: 3, reliability: 4, yield: 4, speed: 1),
      new PilotProfile(4, "Nelson",   skill: 3, reliability: 3, yield: 2, speed: 4),
      new PilotProfile(5, "Antilles", skill: 4, reliability: 3, yield: 3, speed: 3),
      new PilotProfile(6, "Billy",    skill: 4, reliability: 4, yield: 4, speed: 1),
